...
class LoadingScreen:
    ...
    def load_graphics(self):
        ...
        print("[LOADING] Initializing graphics engine...")
    ...
    def load_tracks(self):
        ...
        print("[LOADING] Loading track geometry...")
        ...
        for i, track in enumerate(self.game_context.tracks):
            ...
            if i % 5 == 0:
                print(f"  - Loaded track {i+1}/{len(self.game_context.tracks)}")
    ...
    def load_buildings(self):
        ...
        print("[LOADING] Creating buildings and structures...")
        ...
        print(f"  - Pre-loaded textures for first {texture_count} buildings (rest on-demand)")
        self.assets_loaded['buildings'] = True
        return True
    
    def load_textures(self):
        """Load and cache all game textures"""
        print("[LOADING] Loading game textures...")
        
        # This is called implicitly during building creation
        # Textures are cached using the Building._texture_cache class variable
        print("  - Texture cache populated during building loading")
        self.assets_loaded['textures'] = True
        return True
    
    def load_materials(self):
        """Load and initialize material rendering system"""
        print("[LOADING] Initializing material rendering...")
        
        # Pre-generate environment map textures for vehicle reflections
        try:
            env_map = Car._create_env_map_texture()
            print(f"  - Generated metallic environment map (512x512)")
            
            # Verify vehicle materials are properly initialized
            print(f"  - Metallic material properties loaded (shininess: 128.0)")
            print(f"  - Environment sphere mapping enabled")
        except Exception as e:
            print(f"  - Warning: Material initialization deferred ({str(e)[:30]})")
    ...
    def load_physics(self):
        ...
        print("[LOADING] Initializing physics engine...")
        ...
        print(f"  - Physics engine ready (max_speed={vehicle.max_speed})")
    ...
    def load_lighting(self):
        ...
        print("[LOADING] Setting up lighting system...")
        ...
        print(f"  - Initialized {light_count} lights")
        self.assets_loaded['lighting'] = True
        return True
    
    def load_ai(self):
        """Load and initialize AI systems"""
        print("[LOADING] Loading AI systems...")
