...
class Sign:
    ...
    def __init__(self, x, z, sign_type='stop', custom_text=None, rotation=0.0):
        ...
        # Collision bounds (for post at base)
        self.collision_radius = 0.15  # Radius of sign post collision
        self.collision_height = self.post_height  # Height of collision from ground
    ...
    def check_collision(self, car_x, car_z, car_size=0.6):
        """Check if the car collides with this sign post"""
        # Calculate distance from car center to sign post center
        dx = car_x - self.x
        dz = car_z - self.z
